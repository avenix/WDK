function varargout = VideoAnnotationUI(varargin)
% VIDEOANNOTATIONUI MATLAB code for VideoAnnotationUI.fig
%      VIDEOANNOTATIONUI, by itself, creates a new VIDEOANNOTATIONUI or raises the existing
%      singleton*.
%
%      H = VIDEOANNOTATIONUI returns the handle to a new VIDEOANNOTATIONUI or the handle to
%      the existing singleton*.
%
%      VIDEOANNOTATIONUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VIDEOANNOTATIONUI.M with the given input arguments.
%
%      VIDEOANNOTATIONUI('Property','Value',...) creates a new VIDEOANNOTATIONUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before VideoAnnotationUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to VideoAnnotationUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help VideoAnnotationUI

% Last Modified by GUIDE v2.5 09-Nov-2018 13:36:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @VideoAnnotationUI_OpeningFcn, ...
                   'gui_OutputFcn',  @VideoAnnotationUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before VideoAnnotationUI is made visible.
function VideoAnnotationUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to VideoAnnotationUI (see VARARGIN)

% Choose default command line output for VideoAnnotationUI
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes VideoAnnotationUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = VideoAnnotationUI_OutputFcn(hObject, eventdata, handles) 
