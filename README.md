...
![Event Detection App Detail View](doc/images/3-EventDetectionAppDetail.png)
 ...
 The *Performance Asessment Detail View* shows the raw data next to the video with overlays for each classified segment. Green overlays indicate correctly classified segments and red overlays indicate misclassified segments. The below image 
